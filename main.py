...
async def send_temp_message(context, chat_id, text, delay=5):
    """Send a message and delete it after specified delay"""
    ...
    try:
        if update.message.photo:
            ...
            if is_nsfw:
                ...
                # ارسال پیام موقت که بعد از 5 ثانیه پاک می‌شود
                asyncio.create_task(send_temp_message(
                    context, 
